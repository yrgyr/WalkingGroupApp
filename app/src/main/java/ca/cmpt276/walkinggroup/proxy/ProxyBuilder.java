...
public class ProxyBuilder {
        ...
        caller.enqueue(new Callback<T>() {
            ...
            public void onResponse(Call<T> call, retrofit2.Response<T> response) {
                ...
                if (response.errorBody() == null) {
                    ...
                    String errorMessage = "Can't register, the email address have been used in register.";
                    showFailure(errorMessage);
                }
            }
    ...
    public static <T extends Object> void callProxyForAddUserToGroup(
            final Context context, Call<T> caller, final SimpleCallback<T> callback) {
        caller.enqueue(new Callback<T>() {
            @Override
            public void onResponse(Call<T> call, retrofit2.Response<T> response) {
                ...
                if (response.errorBody() == null) {
                    ...
                    String errorMessage = "Can't add this user; user already a member of this group";
                    showFailure(errorMessage);
                }
            }
    ...
    public static <T extends Object> void callProxyForLeavingGroup(
            final Context context, Call<T> caller, final SimpleCallback<T> callback) {
        caller.enqueue(new Callback<T>() {
            @Override
            public void onResponse(Call<T> call, retrofit2.Response<T> response) {
                ...
                if (response.errorBody() == null) {
                    ...
                    String errorMessage = "You're not in this group anymore!";
                    showFailure(errorMessage);
                }
            }
